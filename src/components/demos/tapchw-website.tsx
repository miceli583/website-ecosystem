...
const CORE_VALUES = [
  {
    icon: Target,
    title: "Advocacy",
    description: "We champion for CHW priorities.",
    color: COLORS.maroon,
  },
  {
    icon: Scale,
    title: "Equity",
    description: "We support fair access in advancement.",
    color: COLORS.navy,
  },
  {
    icon: Shield,
    title: "Integrity",
    description: "We remain true to the CHW/Promotor role.",
    color: COLORS.maroonLight,
  },
  {
    icon: Lightbulb,
    title: "Self-Empowerment",
    description: "We honor the intrinsic value of lived experiences.",
    color: COLORS.navyLight,
  },
  {
    icon: Users,
    title: "Intersectionality",
    description: "We acknowledge and engage different perspectives.",
    color: COLORS.maroon,
  },
  {
    icon: Handshake,
    title: "Unity",
    description: "We connect CHWs/Promotores, allies, & communities.",
    color: COLORS.navy,
  },
];
...
const TESTIMONIALS = [
  {
    quote:
      "TAPCHW has transformed how we approach community health in our region. The training and resources are invaluable.",
    author: "Maria Garcia",
    role: "CHW Instructor",
  ...
  {
    quote:
      "Being part of this network has opened doors I never knew existed. The continuing education opportunities are outstanding.",
  ...
  {
    quote:
      "The advocacy work TAPCHW does at the state level directly impacts our ability to serve our communities effectively.",
...
const MEMBER_LOGOS = [
  {
    ...
    logo: "/demos/tapchw-members/prevent-blindness-texas.png",
  },
  {
    name: "Planned Parenthood Gulf Coast",
    logo: "/demos/tapchw-members/planned-parenthood-gulf-coast.png",
  },
  { name: "UMEMBA Health", logo: "/demos/tapchw-members/umemba-health.png" },
  {
    name: "Border Region Behavioral Health Center",
    logo: "/demos/tapchw-members/border-region-behavioral-health.png",
  },
  { name: "CHW360", logo: "/demos/tapchw-members/chw360.png" },
  {
    name: "Cook Children's Health Plan",
    logo: "/demos/tapchw-members/member-01.png",
  },
  {
    name: "Foundation Communities",
    logo: "/demos/tapchw-members/member-02.png",
  },
  {
    name: "Austin Asian Community Health Initiative",
    logo: "/demos/tapchw-members/member-03.png",
  },
  {
    name: "Empowering the Masses",
    logo: "/demos/tapchw-members/member-04.png",
  },
  {
    name: "UT Tyler School of Medicine",
    logo: "/demos/tapchw-members/member-05.png",
  },
  {
    name: "The Center for Children's Health",
    logo: "/demos/tapchw-members/member-06.png",
  },
  {
    name: "Food Freedom Research Team",
    logo: "/demos/tapchw-members/member-07.png",
  },
  {
    name: "Shurrun's House Sober Living",
    logo: "/demos/tapchw-members/member-08.png",
  },
  {
    name: "Texas Health Resources",
    logo: "/demos/tapchw-members/member-09.png",
  },
];
...
const EVENTS = [
  ...
  {
    date: "May 9th",
    title: "Immunizations and Anti-Immunizations Movement",
    speaker: "Rosalia Guerrero, MBA, CHWI",
    month: "MAY",
    day: "9",
  },
  {
    date: "July 11th",
    title: "Special Member Meeting in Spanish/Español",
    speaker: "",
    month: "JUL",
    day: "11",
  },
...
function AnimatedStat({
  ...
  return (
    <div ref={ref} className="group text-center">
      ...
      <p className="mt-2 text-sm font-medium tracking-wider text-white/60 uppercase">
        {label}
      </p>
    </div>
  );
...
function LogoCarousel({ title }: { title: string }) {
  ...
  return (
    <div className="py-16">
      <p
        className="mb-10 text-center text-sm font-semibold tracking-widest uppercase"
        style={{ color: COLORS.navy }}
      >
        {title}
      </p>
      <div className="relative overflow-hidden">
        <div className="pointer-events-none absolute top-0 left-0 z-10 h-full w-32 bg-gradient-to-r from-white to-transparent sm:w-48" />
        <div className="pointer-events-none absolute top-0 right-0 z-10 h-full w-32 bg-gradient-to-l from-white to-transparent sm:w-48" />
          ...
          {doubledLogos.map((member, i) => (
            ...
            >
              <div
                ...
                style={{
                  background: `radial-gradient(circle at center, ${COLORS.navy}08 0%, transparent 70%)`,
                }}
              />
              <Image
                src={member.logo}
  ...
  return (
    <div className="relative">
      <button
        ...
        className="absolute top-1/2 -left-4 z-10 hidden -translate-y-1/2 rounded-full bg-white p-3 shadow-lg transition-all hover:scale-110 md:block"
      ...
      <button
        ...
        className="absolute top-1/2 -right-4 z-10 hidden -translate-y-1/2 rounded-full bg-white p-3 shadow-lg transition-all hover:scale-110 md:block"
        style={{ color: COLORS.maroon }}
      >
      ...
      <div className="mx-auto max-w-3xl px-4 pb-8 text-center">
        <Quote
          className="mx-auto mb-8 h-16 w-16 opacity-10"
          style={{ color: COLORS.maroon }}
        />
        ...
        <div className="relative h-[320px] overflow-hidden sm:h-[280px]">
          {TESTIMONIALS.map((testimonial, i) => (
            ...
            >
              <p className="mb-8 font-serif text-xl leading-relaxed text-gray-700 italic sm:text-3xl">
              ...
              <div className="flex items-center justify-center gap-4">
                ...
                <div className="text-left">
                  <p className="font-bold" style={{ color: COLORS.maroon }}>
                    {testimonial.author}
                  </p>
        ...
        <div className="mt-10 flex justify-center gap-3">
          {TESTIMONIALS.map((_, i) => (
            <button
              ...
              style={{
                backgroundColor: i === current ? COLORS.maroon : "#e5e7eb",
              }}
            />
          ))}
        </div>
  ...
  return (
    <div>
      ...
      <section
        ...
        style={{
          background: `linear-gradient(160deg, ${COLORS.navyDark} 0%, ${COLORS.navy} 25%, ${COLORS.navyLight} 55%, #D0E0F0 85%, #E8F0F8 100%)`,
        }}
      >
              ...
              <div className="text-center lg:text-left">
                <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-5 py-2.5 backdrop-blur-md">
                  ...
                  <span className="text-sm font-medium text-white">
                    Texas CHW Association
                  </span>
                </div>

                <h1
                  className="mb-6 font-serif text-5xl leading-tight font-bold sm:text-6xl lg:text-7xl xl:text-8xl"
                  style={{
                    color: COLORS.gold,
                    textShadow: `1px 1px 0 rgba(0,0,0,0.15), 2px 2px 6px rgba(0,0,0,0.2)`,
                  }}
                >
                  Howdy!
                </h1>
                ...
                <p className="mb-8 text-lg leading-relaxed text-white/80 sm:text-xl">
                  As the state CHW Association, TAPCHW is here to serve CHWs and
                  promotoras across Texas. Let us know what we can do to support
                ...
                <div className="flex flex-col items-center gap-4 sm:flex-row lg:justify-start">
                  <Button
                    ...
                    style={{
                      background: `linear-gradient(135deg, ${COLORS.maroon} 0%, ${COLORS.maroonLight} 100%)`,
                      boxShadow: `0 0 30px ${COLORS.maroon}40, 0 0 60px ${COLORS.maroon}20`,
                    }}
              ...
              <div className="relative flex justify-center px-6 py-8 sm:px-0 sm:py-0">
                ...
                <div className="relative z-10 flex items-center justify-center">
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "radial-gradient(circle, rgba(255,255,255,0.25) 0%, rgba(255,255,255,0.08) 70%, transparent 100%)",
                      boxShadow:
                ...
                <div className="absolute top-1/4 left-0 hidden rounded-xl bg-white/95 p-3 shadow-lg backdrop-blur sm:-left-8 sm:block">
                ...
                <div className="absolute right-0 bottom-1/4 hidden rounded-xl bg-white/95 p-3 shadow-lg backdrop-blur sm:-right-8 sm:block">
                  <div className="flex items-center gap-2">
                    <div
                      className="rounded-full p-2"
                      style={{ backgroundColor: `${COLORS.maroon}15` }}
                    >
                      <Award
                        className="h-4 w-4"
                        style={{ color: COLORS.maroon }}
      ...
      <section
        ...
        style={{ borderColor: "rgba(53, 79, 139, 0.1)" }}
      >
      ...
      >
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h2
            className="mb-6 font-serif text-4xl font-bold sm:text-5xl"
            style={{ color: COLORS.maroon }}
          >
            Empowering Texas <br className="sm:hidden" />
            CHWs Since <br className="sm:hidden" />
            Day One
          </h2>
          <p className="text-lg leading-relaxed text-gray-600">
            We are a 501(c)3 non-profit professional organization that offers
            membership and supports the Community Health Worker (CHW) workforce
            through continuing education, job opportunities, and various CHW-led
      ...
      <section className="px-4 py-12 sm:py-16 lg:py-24">
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-6 md:grid-cols-2">
            <Card
              className="group overflow-hidden border border-transparent bg-white shadow-xl transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl"
              style={{ borderImage: "none" }}
              onMouseEnter={(e) => {
                e.currentTarget.style.borderColor = `${COLORS.navy}25`;
                e.currentTarget.style.boxShadow = `0 25px 50px -12px ${COLORS.navy}15`;
              }}
              onMouseLeave={(e) => {
            ...
            >
              <CardContent className="p-8">
                ...
                <p className="text-lg text-gray-600">
                  To support and expand opportunities for the CHW profession at
                  the state and local level through Advocacy, Education,
                  Employment, Empowerment, and Policy.
                </p>
              </CardContent>
            </Card>
            ...
            <Card
              ...
              style={{ borderImage: "none" }}
              onMouseEnter={(e) => {
                e.currentTarget.style.borderColor = `${COLORS.maroon}25`;
                e.currentTarget.style.boxShadow = `0 25px 50px -12px ${COLORS.maroon}15`;
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.borderColor = "transparent";
                e.currentTarget.style.boxShadow = "";
            ...
            >
              <CardContent className="p-8">
                ...
                <p className="text-lg text-gray-600">
                  Elevate the voices of Texas Community Health Workers and
                  Promotores.
                </p>
              </CardContent>
            </Card>
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-2 backdrop-blur-sm">
            ...
            <span className="text-sm text-white/90">
              Join 5,000+ CHWs across Texas
            </span>
          </div>
          <h2 className="mb-6 font-serif text-4xl font-bold text-white sm:text-5xl lg:text-6xl">
            Ready to Join Our Community?
          </h2>
          <p className="mx-auto mb-10 max-w-2xl text-lg leading-relaxed text-white/80">
            Connect with CHWs across Texas, access exclusive resources, and grow
            your career.
          </p>
    ...
    <div>
      ...
      >
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <h1 className="mb-6 font-serif text-5xl font-bold text-white sm:text-6xl">
            About TAPCHW
          </h1>
          <p className="text-xl text-white/80">
            We are a 501(c)3 non-profit professional organization dedicated to
            supporting the Community Health Worker workforce across Texas.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div
              ...
              style={{
                background: `linear-gradient(160deg, ${COLORS.navyDark} 0%, ${COLORS.navy} 25%, ${COLORS.navyLight} 60%, #B8D0E8 100%)`,
              }}
            >
              <div className="flex h-full items-center justify-center py-8 sm:py-12 lg:py-0">
                <div className="relative flex items-center justify-center">
                  ...
                  <Image
                    ...
                    width={250}
                    height={250}
                    className="relative h-[150px] w-[150px] translate-x-[1px] translate-y-[4px] object-contain sm:h-[250px] sm:w-[250px] sm:translate-y-[8px]"
                    style={{
                      filter: "saturate(1) brightness(1.05) contrast(1.05)",
                    }}
                  />
              ...
              return (
                ...
                >
                  <CardContent className="relative p-7">
                    {/* Hover glow */}
                    <div
                      className="pointer-events-none absolute -top-8 -right-8 h-32 w-32 rounded-full opacity-0 blur-2xl transition-opacity duration-500 group-hover:opacity-100"
      ...
      <CardContent className="p-4 sm:p-6">
        ...
        <div className="grid grid-cols-7">
          {daysOfWeek.map((day) => (
            <div
              key={day}
              className="border-b py-2 text-center text-xs font-semibold text-gray-400"
              style={{ borderColor: `${COLORS.navy}15` }}
            >
              {day}
            </div>
        ...
        <div
          className="mt-4 flex items-center gap-4 border-t pt-4 text-xs sm:mt-6 sm:pt-4"
          style={{ borderColor: `${COLORS.navy}15` }}
        >
          <div className="flex items-center gap-2">
            <div
          ...
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div>
              <h2
                ...
                style={{ color: COLORS.navy }}
              >
                2025 Quarterly Member Meetings
              </h2>
              <p className="mb-6 text-gray-600">
                Third Fridays of the month, quarterly, 12:00 pm - 1:30 pm CST
              </p>
              ...
              <div className="space-y-4">
                {EVENTS.map((event, i) => (
                  <Card
                    key={i}
                    className="group overflow-hidden border-0 bg-white shadow-lg transition-all hover:-translate-y-1 hover:shadow-xl"
                  >
  ...
  const sections = [
    {
      ...
      icon: BookOpen,
      items: RESOURCES.training,
      color: COLORS.maroon,
    },
    {
      title: "Program Toolkits",
      icon: Wrench,
      items: RESOURCES.toolkits,
      color: COLORS.navy,
    },
    {
      title: "Research & Reports",
      icon: FileText,
      items: RESOURCES.research,
      color: COLORS.maroonLight,
    },
    {
    ...
    <div>
      ...
      >
        <div className="mx-auto max-w-4xl">
          ...
          <h1 className="mb-6 font-serif text-3xl font-bold text-white sm:text-5xl">
            CHW Resources
          </h1>
          <Button
                    ...
                    <div className="space-y-2">
                      {section.items.map((item, i) => (
                        <a
                          key={i}
                          href="#"
                          className="flex items-center gap-2 rounded-lg p-2 text-sm text-gray-600 transition-colors hover:bg-gray-50"
                        >
                          <ExternalLink
  ...
  const requestTypes = [
    {
      ...
      description: "Develop NEW training curriculum",
      icon: BookOpen,
    },
    {
      title: "Training for Members",
      description: "Provide training to TAPCHW members",
      icon: Users,
    },
    {
      title: "Training for Orgs",
      description: "TAPCHW training for your organization",
      icon: Building2,
    },
  ];
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {requestTypes.map((type) => {
              ...
              return (
                <Card
                  key={type.title}
                  className="group border-0 bg-white text-center shadow-lg transition-all hover:-translate-y-2 hover:shadow-xl"
                >
                  <CardContent className="p-6">
                    <div
                      className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl transition-all group-hover:scale-110"
                      style={{
                        background: `linear-gradient(135deg, ${COLORS.navy}15 0%, ${COLORS.navy}25 100%)`,
                      }}
                    >
                      <Icon
                        className="h-8 w-8"
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {CURRICULA.map((item, i) => (
              <div
                key={i}
                className="flex items-center gap-3 rounded-lg bg-white/10 p-3 text-sm text-white"
              >
            ...
            {MEMBERSHIP_TIERS.map((tier) => (
              <Card
                ...
                className={`group relative overflow-hidden border-0 bg-white shadow-xl transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl ${
                  tier.popular
                    ? "ring-2 ring-amber-400 ring-offset-2 sm:ring-offset-4"
                    : ""
                }`}
              >
                {tier.popular && (
                  <div className="absolute top-6 -right-12 rotate-45 bg-amber-400 px-12 py-1 text-xs font-bold text-white">
                    BEST VALUE
                  </div>
                )}
                ...
                <CardContent className="p-6">
                  <Button
                    className="mb-6 w-full text-white transition-all group-hover:scale-105"
      ...
      >
        <div className="mx-auto max-w-4xl text-center">
          <p className="text-white">
            ...
            <a
              href="mailto:membership@tapchw.org"
              className="font-semibold underline"
            >
              membership@tapchw.org
            </a>
          </p>
        </div>
      </section>
              ...
              {[
                {
                  ...
                  value: "info@tapchw.org",
                },
                {
                  icon: Users,
                  label: "Membership",
                  value: "membership@tapchw.org",
                },
                {
                  icon: GraduationCap,
                  label: "Training",
                  value: "training@tapchw.org",
                },
              ].map((item) => {
              ...
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                <div className="grid gap-4 sm:grid-cols-2">
                  <Input
                    ...
                    className="h-12 !border-gray-200 !bg-white text-base !text-gray-900 !ring-0 placeholder:!text-gray-400 focus:!border-gray-300 focus:!bg-white focus:!ring-0 sm:text-sm"
                  />
                  <Input
                ...
                <Textarea
                  ...
                  className="min-h-[120px] !border-gray-200 !bg-white text-base !text-gray-900 !ring-0 placeholder:!text-gray-400 focus:!border-gray-300 focus:!bg-white focus:!ring-0 sm:text-sm"
                />
                <Button
...
function LoginPage({ onLogin }: { onLogin: (user: DemoUser) => void }) {
  ...
  return (
    <div
      className="flex min-h-[80vh] items-center justify-center px-4 py-20"
      style={{ backgroundColor: COLORS.cream }}
    >
      <Card
        ...
        <CardContent className="p-8">
          <div className="mb-8 text-center">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Sign in to your TAPCHW account
            </p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="h-12 !border-gray-200 !bg-white pl-10 text-base !text-gray-900 !ring-0 placeholder:!text-gray-400 focus:!border-gray-300 focus:!bg-white focus:!ring-0 sm:text-sm"
                />
              </div>
            </div>
            <div>
          ...
          <div className="mt-6 rounded-lg border border-gray-100 bg-gray-50 p-4">
            ...
            <div className="space-y-1 text-xs text-gray-600">
              <p>
                <span className="font-medium">Member:</span> maria@tapchw.org /
                demo123
              </p>
              <p>
                <span className="font-medium">Admin:</span> admin@tapchw.org /
                admin123
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-white/70">
                {user.role === "admin" ? "Administrator" : "Member"} · Since{" "}
                {user.memberSince}
              </p>
            </div>
          </div>
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-2">
                  <Button
                    variant="outline"
                    size="sm"
                    className="w-full justify-start !border-gray-200 !bg-white !text-gray-700 hover:!bg-gray-50"
          ...
          <div className="mt-8">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {EVENTS.slice(0, 2).map((event, i) => (
                <Card
                  key={i}
                  className="group overflow-hidden border bg-white shadow-md transition-all hover:-translate-y-1 hover:shadow-lg"
                  style={{ borderColor: `${COLORS.navy}15` }}
                >
                  <CardContent className="flex items-center gap-0 p-0">
                    <div
                      className="flex w-20 flex-shrink-0 flex-col items-center justify-center py-6"
                      style={{
                        background: `linear-gradient(135deg, ${COLORS.maroon} 0%, ${COLORS.maroonLight} 100%)`,
                      }}
                    >
          ...
          <div className="mt-8">
            ...
            >
              <CardContent className="p-0">
                {[
                  {
                    action: "Completed CE: Trauma Informed Care",
                    time: "2 days ago",
                    icon: CheckCircle2,
                  },
                  {
                    action: "Registered for Heart Disease Prevention Meeting",
                    time: "1 week ago",
                    icon: Calendar,
                  },
                  {
                    action: "Downloaded: CDC CHW Toolkit",
                    time: "2 weeks ago",
                    icon: Download,
                  },
                  {
                    action: "Membership renewed for 2025",
                    time: "1 month ago",
                    icon: UserCheck,
                  },
                ].map((item, i) => {
                  ...
                  return (
                    ...
                    >
                      <Icon
                        ...
                        style={{
                          color: i % 2 === 0 ? COLORS.navy : COLORS.maroon,
                        }}
                      />
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: COLORS.cream }}>
      <section
        className="px-4 py-8"
        style={{
          background: `linear-gradient(135deg, ${COLORS.maroonDark} 0%, ${COLORS.navyDark} 100%)`,
        }}
      >
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mt-1 text-white/60">
            TAPCHW Site Analytics & Management
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {[
              {
                label: "Total Members",
                value: ANALYTICS_DATA.totalMembers.toLocaleString(),
              ...
              },
              {
                ...
                value: `$${ANALYTICS_DATA.monthlyRevenue.toLocaleString()}`,
              ...
              },
              {
                ...
                value: ANALYTICS_DATA.eventRegistrations.toString(),
                change: "Next: Feb 14",
                icon: Calendar,
                color: COLORS.navyLight,
              },
              {
                ...
                value: ANALYTICS_DATA.resourceDownloads.toLocaleString(),
                change: "+89 this week",
                icon: Download,
                color: COLORS.maroonLight,
              },
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-3">
            <Card
              className="border bg-white shadow-lg lg:col-span-2"
              style={{ borderColor: `${COLORS.navy}15` }}
            >
              <CardContent className="p-6">
                ...
                <div className="flex h-48 gap-3">
                  {ANALYTICS_DATA.memberGrowth.map((item) => {
                    const maxVal = Math.max(
                      ...ANALYTICS_DATA.memberGrowth.map((d) => d.value)
                    );
            ...
            >
              <CardContent className="p-6">
                <h3 className="mb-4 font-bold" style={{ color: COLORS.maroon }}>
                  Top Resources
                </h3>
                <div className="space-y-4">
                ...
                >
                  <CardContent className="p-5">
                    ...
                    <p className="mt-2 text-xs text-gray-400">
                      ${(count * tier.price).toLocaleString()} revenue /{" "}
                      {tier.period}
                    </p>
                  </CardContent>
                </Card>
  ...
  const renderPage = () => {
    switch (currentPage) {
      ...
      case "member-dashboard":
        return currentUser ? (
          <MemberDashboard user={currentUser} setPage={setCurrentPage} />
        ) : (
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-white">
      ...
      {!announcementDismissed && !isAuthPage && (
        <div
          className="relative z-40 px-4 py-2 text-center text-sm text-white"
          style={{
            background: `linear-gradient(90deg, ${COLORS.navyDark} 0%, ${COLORS.navy} 50%, ${COLORS.navyDark} 100%)`,
          }}
        >
          <span className="mr-2 inline-flex items-center gap-1.5">
            ...
            <span className="hidden text-white/60 sm:inline">
              — Immunizations & Anti-Immunizations Movement
            </span>
          </span>
          <button
            onClick={() => setAnnouncementDismissed(true)}
            className="absolute top-1/2 right-3 -translate-y-1/2 rounded p-0.5 text-white/50 transition-colors hover:text-white"
          >
      ...
      {/* Navigation */}
      <nav
        className={`sticky top-0 z-40 transition-all duration-300 ${scrolled ? "bg-white/95 shadow-lg backdrop-blur-md" : "bg-white shadow-sm"}`}
      >
          ...
          <div className="hidden items-center gap-1 lg:flex">
            {NAV_ITEMS.map((item) => (
              <button
                ...
                style={{
                  color: currentPage === item.id ? COLORS.maroon : COLORS.navy,
                }}
              >
                {item.label}
                {currentPage === item.id && (
      ...
      >
        <div className="mx-auto max-w-6xl px-4 py-16">
          <div className="grid gap-8 md:grid-cols-4 md:gap-12">
            <div className="md:col-span-2">
              ...
              <p className="max-w-sm text-sm text-white/70">
                A 501(c)(3) non-profit serving all Community Health Workers
                across Texas, led by certified CHWs and CHW Instructors.
              </p>
            </div>
          ...
          <div className="mt-12 border-t border-white/10 pt-8 text-center text-sm text-white/50">
            © 2025 Texas Association of Promotores & Community Health Workers.
            All rights reserved.
          </div>
          <div
            className="mx-auto mt-6 w-fit rounded-md border border-white/5 bg-white/[0.03] px-4 py-2 text-center text-sm font-medium"
            style={{ color: COLORS.gold }}
          >
            Website designed and developed in partnership with{" "}
            <span className="font-bold">CHW360</span>
          </div>
        </div>
      </footer>
      ...
      <button
        ...
        className={`fixed right-6 bottom-6 z-50 flex h-12 w-12 items-center justify-center rounded-full text-white shadow-2xl transition-all duration-300 ${showBackToTop ? "translate-y-0 opacity-100" : "pointer-events-none translate-y-4 opacity-0"}`}
        style={{
          background: `linear-gradient(135deg, ${COLORS.maroon} 0%, ${COLORS.maroonLight} 100%)`,
        }}
      >
