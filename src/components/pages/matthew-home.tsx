        ...
        <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 sm:py-12">
          ...
          <section className="mb-12 sm:mb-16">
            <div className="flex items-start justify-between gap-4 sm:gap-6 md:gap-8">
              <div className="flex-1 space-y-3 sm:space-y-4 md:space-y-6">
                ...
                <div className="animate-fade-in-delay-1 max-w-2xl">
                  <p className="text-sm text-gray-100 drop-shadow-md sm:text-base md:text-lg lg:text-xl">
                    Digital Architect & Integrations Specialist. Integrating
                    disciplines to design systems that honor what makes us
                    human.
                    <br />
                    Founder of{" "}
                    <Link
              ...
              <div className="animate-fade-in-delay-2 flex-shrink-0">
                <div
                  className="h-24 w-24 overflow-hidden rounded-full border-2 shadow-2xl sm:h-32 sm:w-32 md:h-40 md:w-40 lg:h-42 lg:w-42"
                  style={{
                    borderColor: "#D4AF37",
            ...
            <div className="animate-fade-in-delay-3">
              ...
              <div className="max-w-none space-y-4">
                <p className="text-gray-100 drop-shadow-sm">
                  I&apos;m a systems architect who bridges worlds—transforming
                  vision into reality through the integration of diverse
                  disciplines. My path has taken me through robotics research,
                  satellite testing, software development, high-ticket sales,
                  and music production.
                </p>
                <p className="text-gray-100 drop-shadow-sm">
                  This breadth has shaped my approach: I thrive in the spaces
                  between fields, connecting engineering with business,
                  technology with creativity, individual insight with collective
                  impact. I illuminate unseen patterns and design systems that
                  honor each part within the greater whole.
                </p>
                <p className="text-gray-100 drop-shadow-sm">
                  Today, I apply this integrative thinking alongside deep
                  technical expertise in AI-driven development, creating
                  full-stack applications and enterprise solutions that
                  strengthen human connection and honor our humanity.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12 sm:mb-16">
            <div className="animate-fade-in-delay-3-5">
              ...
              <Link href="/blog/honoring-our-humanity">
                <Card
                  className="group cursor-pointer backdrop-blur-md transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl"
                  style={{
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <h3 className="mb-3 text-xl font-bold text-white group-hover:underline sm:text-2xl">
                          Honoring Our Humanity: Technology as Guardian, Not
                          Replacement
                        </h3>
                        <p className="mb-4 text-sm leading-relaxed text-gray-200 sm:text-base">
                          In an age where AI can outperform us in countless
                          tasks, we must ask: what does it mean to be human? And
                          how do we build technology that strengthens—rather
                          than erodes—the connections that make us whole?
                        </p>
                        <div
                ...
                {testimonials.map((testimonial, index) => (
                  <Card
                    ...
                    style={{
                      ...
                      borderWidth: "1px",
                      background:
                        "linear-gradient(135deg, rgba(246, 230, 193, 0.12) 0%, rgba(107, 29, 54, 0.12) 100%)",
                  ...
                  >
                    <CardContent className="p-5">
                      ...
                      <div
                        className="mt-3 flex items-center gap-1 text-xs font-semibold transition-all group-hover:gap-2"
                        style={{ color: "#D4AF37" }}
                      >
                        <span>Read more</span>
              ...
              {expandedTestimonial !== null && (
                <div className="fixed inset-0 z-50">
                  ...
                  <div className="pointer-events-none relative flex h-full items-center justify-center p-4">
                    <Card
                      className="pointer-events-auto relative flex max-h-[80vh] w-full max-w-2xl flex-col"
                      style={{
                        borderColor: "rgba(212, 175, 55, 0.3)",
                        borderWidth: "1px",
                        background: "#0a0a0a",
                            ...
                            <div className="mb-6 flex items-center gap-4 pr-10">
                              ...
                              <div>
                                <p className="text-lg font-semibold text-white">
                                  {testimonials[expandedTestimonial].name}
                                </p>
                                <p
                                  className="text-sm"
                                  style={{ color: "#D4AF37" }}
                                >
                                  {testimonials[expandedTestimonial].role}
                                </p>
                              </div>
                            </div>
            ...
            <div className="animate-fade-in-delay-5">
              <Card
                ...
                style={{
                  ...
                  borderWidth: "1px",
                  background:
                    "linear-gradient(135deg, rgba(246, 230, 193, 0.1) 0%, rgba(107, 29, 54, 0.1) 100%)",
                }}
              >
                <CardContent className="p-6 sm:p-8">
                  <div className="flex items-start gap-6">
                    <div className="relative h-16 w-16 flex-shrink-0">
                      <Image
                        ...
                        style={{
                          filter:
                            "drop-shadow(0 10px 25px rgba(212, 175, 55, 0.3))",
                        }}
                      />
                    </div>
                    <div className="flex-1">
                      ...
                      <p className="mb-4 text-base text-gray-100 drop-shadow-sm sm:text-lg">
                        In 2025, I founded Miracle Mind with a clear mission:
                        develop technology that empowers human sovereignty and
                        genuine connection.
                      </p>
                      <p className="mb-4 text-gray-200 drop-shadow-sm">
                        In a climate where AI&apos;s trajectory remains
                        uncertain, our mission is to serve as both steward and
                        safeguard—nurturing the technologies that enhance our
                        humanity while building protections against those that
                        diminish it.
                      </p>
                      <p className="mb-6 text-gray-200 drop-shadow-sm">
                        ...
                        , is an AI-assisted Life Operating System that
                        integrates habits, projects, finances, and wellbeing as
          ...
          <section className="mb-12 sm:mb-16">
            <div className="animate-fade-in-delay-6">
              ...
              <div className="max-w-none space-y-4">
                <p className="text-gray-100 drop-shadow-sm">
                  Building full-stack web applications, SaaS platforms, and
                  enterprise-level solutions with AI-driven development. My
                  current tech stack:
                </p>
            ...
            <div className="animate-fade-in-delay-7">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <Link href={playgroundUrl}>
                  <Card
                    className="group cursor-pointer bg-white/10 backdrop-blur-md transition-all duration-300 hover:scale-105 hover:bg-white/20 hover:shadow-xl"
                    style={{
                      borderColor: "rgba(212, 175, 55, 0.3)",
                      borderWidth: "1px",
                    }}
          ...
          {/* Contact Section */}
          <section id="contact" className="mb-12 scroll-mt-24 sm:mb-16">
