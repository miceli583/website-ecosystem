    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            Thank you for signing up for early access to BANYAN LifeOS.
            We&apos;re building something special, and we&apos;re thrilled to
            have you along for the journey.
          </Text>
          <Text style={text}>
            We&apos;ll reach out as soon as your spot is ready. In the meantime,
