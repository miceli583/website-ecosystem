      ...
      <div className="min-h-screen bg-black text-white">
        <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
          ...
          <p className="mb-12 max-w-2xl text-lg leading-relaxed text-gray-300">
            ...
            our mission. These are companies and individuals we
            steward—endorsing their products and services because we believe in
            their positive impact on the people we serve.
          </p>
