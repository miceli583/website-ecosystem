...
const gammaPressentations = [
  {
    ...
    description:
      "Foundation module covering time management, task tracking, and accountability systems for CHWs.",
    slides: 60,
  ...
  },
  {
    ...
    description:
      "Applied organizational skills with real-world CHW workflows and scenarios.",
    slides: null,
    url: null,
  ...
  },
  {
    ...
    description:
      "Advanced techniques for high-volume work and team coordination.",
    slides: null,
    url: null,
    status: "coming-soon" as const,
  },
  {
    ...
    description:
      "Integrated practice combining all organizational competencies.",
    slides: null,
    url: null,
    status: "coming-soon" as const,
  },
      ...
      <main className="mx-auto max-w-5xl px-6 py-12">
        ...
        <div className="mb-10">
          ...
          <p className="max-w-2xl text-lg text-gray-400">
            AI-generated presentation decks for your CHW training modules. View
            online, export to PowerPoint, or download as PDF.
          </p>
        </div>
        ...
        >
          <div className="flex items-start gap-3">
            ...
            />
            <div>
              <p className="font-medium" style={{ color: "#F6E6C1" }}>
                Powered by Gamma AI
              </p>
              <p className="mt-1 text-sm text-gray-400">
                These presentations are generated using your training content
                and can be exported to PowerPoint or PDF for offline use.
              </p>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <p className="mt-2 text-xs text-gray-600">
            Presentations can be edited in Gamma, exported to PowerPoint
            (.pptx), or downloaded as PDF for offline training sessions.
          </p>
        </div>
      </main>
    </div>
