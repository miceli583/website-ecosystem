...
const slideImages = {
  community: "https://images.unsplash.com/photo-1582213782179-e0d53f98f2ca?w=800&h=500&fit=crop",
  collaboration: "https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=800&h=500&fit=crop",
  tablet: "https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=800&h=500&fit=crop",
  group: "https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=800&h=500&fit=crop",
  trust: "https://images.unsplash.com/photo-1521791136064-7986c2920216?w=800&h=500&fit=crop",
  wellness: "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=800&h=500&fit=crop",
  communication: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=800&h=500&fit=crop",
  reliability: "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=800&h=500&fit=crop",
} as const;

// Get appropriate image URL based on description
function getImageUrl(description: string): string {
  const lower = description.toLowerCase();
  if (lower.includes("collaborat") || lower.includes("community member")) return slideImages.community;
  if (lower.includes("group") || lower.includes("team")) return slideImages.group;
  if (lower.includes("tablet") || lower.includes("tracking") || lower.includes("system")) return slideImages.tablet;
  if (lower.includes("trust") || lower.includes("rapport")) return slideImages.trust;
  if (lower.includes("wellness") || lower.includes("self-care") || lower.includes("balance")) return slideImages.wellness;
  if (lower.includes("communication") || lower.includes("professional")) return slideImages.communication;
...
function SlideImage({ description, className = "" }: { description: string; className?: string }) {
  const imageUrl = getImageUrl(description);
  const [isLoaded, setIsLoaded] = useState(false);

  return (
    <div className={`relative overflow-hidden rounded-2xl shadow-xl bg-black/20 ${className}`}>
      {/* Loading skeleton */}
      {!isLoaded && (
...
function KeyPointCard({ point, icon: Icon }: { point: string; index: number; icon?: React.ElementType }) {
  ...
  return (
    <div className="flex items-center gap-3 p-3 rounded-xl bg-white/10 backdrop-blur-sm border border-white/10">
      <div className="flex-shrink-0 h-8 w-8 rounded-lg bg-gradient-to-br from-[#D8A75F] to-[#c9954a] flex items-center justify-center shadow">
...
function Slide({
  ...
  return (
    <div
      id={`slide-${slide.num}`}
      className={`relative w-full h-screen overflow-hidden bg-gradient-to-br ${config.bgGradient} transition-all duration-500`}
    >
      {/* Decorative pattern */}
      <SlidePattern type={type} opacity={config.patternOpacity} />

      {/* Content container - fills parent height */}
      <div className="relative z-10 h-full flex flex-col px-8 sm:px-16 lg:px-24 xl:px-32 py-6 lg:py-10">
        {/* Header row */}
        ...
        <div className="flex-1 min-h-0 flex flex-col justify-center max-w-6xl mx-auto w-full overflow-hidden">
          {type === "title" ? (
            ...
            <div className="text-center space-y-4 lg:space-y-6">
              ...
              <div className="flex justify-center">
                <div
                  className="relative inline-flex items-center justify-center h-20 w-20 lg:h-24 lg:w-24 rounded-2xl shadow-2xl transform hover:scale-105 transition-transform duration-500"
                  style={{ backgroundColor: config.iconBg }}
                >
                  <Layers className="h-10 w-10 lg:h-12 lg:w-12 text-white" />
                  {/* Glow effect */}
              ...
              <div className="space-y-2">
                ...
                <p className="text-xl sm:text-2xl lg:text-3xl font-light text-white/80 tracking-wide">
                  Part 1: Foundation
                </p>
              </div>
              ...
              <div className="flex items-center justify-center gap-3">
                <div className="h-1 w-12 rounded-full" style={{ backgroundColor: config.accentColor }} />
                <div className="h-2 w-2 rounded-full" style={{ backgroundColor: config.accentColor }} />
                <div className="h-1 w-12 rounded-full" style={{ backgroundColor: config.accentColor }} />
              </div>

              {/* Description */}
              <p className="text-base lg:text-lg text-white/80 max-w-3xl mx-auto leading-relaxed font-light">
                {slide.content}
              </p>
              ...
              <SlideImage
                ...
                className="h-32 lg:h-40 max-w-xl mx-auto"
              />
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-12">
              ...
              <div className="flex-shrink-0 relative">
                <div
                  className="flex items-center justify-center h-32 w-32 lg:h-40 lg:w-40 rounded-full shadow-2xl transform hover:scale-105 transition-transform duration-500"
                  style={{
                    background: `linear-gradient(135deg, ${config.iconBg} 0%, #c9954a 100%)`,
                  }}
                >
                  <span className="text-6xl lg:text-7xl font-black text-white">{objectiveNum}</span>
                </div>
                {/* Decorative ring */}
                <div
              ...
              <div className="flex-1 text-center lg:text-left space-y-4">
                ...
                <div className="h-1 w-20 rounded-full mx-auto lg:mx-0" style={{ backgroundColor: config.accentColor }} />
            ...
            <div className="text-center space-y-5">
              ...
              <div className="flex justify-center">
                <div className="relative">
                  <div
                    className="inline-flex items-center justify-center h-18 w-18 lg:h-20 lg:w-20 rounded-2xl shadow-2xl"
                    style={{ backgroundColor: config.iconBg }}
                  >
                    <ClipboardList className="h-9 w-9 lg:h-10 lg:w-10 text-white" />
                  </div>
                  {/* Pulse rings */}
                  <div className="absolute inset-0 rounded-2xl border-4 border-white/20 animate-ping" style={{ animationDuration: '2s' }} />
                </div>
              </div>
              ...
              {/* Content card */}
              <div className="max-w-3xl mx-auto p-6 lg:p-8 rounded-2xl bg-white/10 backdrop-blur-sm border border-white/20 shadow-xl">
              ...
              <div className="flex flex-col items-center gap-2">
                <div className="h-20 w-20 lg:h-24 lg:w-24 rounded-xl border-4 border-dashed border-white/40 flex items-center justify-center bg-white/5 backdrop-blur-sm">
                  <div className="text-center">
                    <div className="grid grid-cols-3 gap-1 p-1.5">
                      {[...Array(9)].map((_, i) => (
                        <div key={i} className="h-2 w-2 bg-white/40 rounded-sm" />
                      ))}
                    </div>
                    <span className="text-white/50 text-[10px] font-medium">QR Code</span>
                  </div>
                </div>
                <p className="text-white/60 text-xs">Scan to begin assessment</p>
              </div>
            </div>
          ) : type === "case" ? (
            ...
            <div className="space-y-5 lg:space-y-6">
              ...
              <div className="flex items-center gap-4">
                <div
                  className="flex items-center justify-center h-14 w-14 lg:h-16 lg:w-16 rounded-xl shadow-lg"
                  style={{ backgroundColor: config.iconBg }}
                >
                  <Users className="h-7 w-7 lg:h-8 lg:w-8 text-white" />
                </div>
                <div>
                  <p className="text-xs font-semibold text-white/60 uppercase tracking-widest mb-1">Real-World Scenario</p>
                  <h2
                    className="text-2xl sm:text-3xl lg:text-4xl font-bold"
                    style={{ color: config.accentColor }}
                  >
              ...
              <div className="relative">
                {/* Large quote mark */}
                <div
                  className="absolute -top-6 -left-2 text-6xl lg:text-7xl font-serif opacity-20"
                  style={{ color: config.accentColor }}
                >
                  &ldquo;
                </div>
                ...
                <div
                  className="relative p-6 lg:p-8 rounded-2xl border-l-6 bg-white/10 backdrop-blur-sm shadow-xl"
                  style={{ borderColor: config.iconBg }}
                >
                  <p className="text-lg lg:text-xl text-white/90 leading-relaxed italic pl-4">
                    {slide.content}
                  </p>

                  {/* Scenario detail if available */}
                  {(slide as typeof slides[0] & { scenario?: string }).scenario && (
                    <p className="mt-4 pt-4 border-t border-white/20 text-base text-white/70 pl-4">
              ...
              <SlideImage
                ...
                className="h-28 lg:h-36 max-w-md"
              />
            </div>
          ) : type === "reflection" ? (
            ...
            <div className="text-center space-y-5 lg:space-y-6">
              ...
              <div className="flex justify-center">
                <div className="relative">
                  <div
                    className="inline-flex items-center justify-center h-18 w-18 lg:h-20 lg:w-20 rounded-full shadow-xl"
                    style={{ backgroundColor: config.iconBg }}
                  >
                    <Lightbulb className="h-9 w-9 lg:h-10 lg:w-10 text-white" />
                  </div>
                  {/* Light rays */}
                  <div className="absolute inset-0 flex items-center justify-center">
                    {[0, 45, 90, 135, 180, 225, 270, 315].map((deg) => (
                      <div
                        key={deg}
                        className="absolute h-1 w-6 bg-gradient-to-r from-[#2E8A92]/40 to-transparent origin-left"
                        style={{ transform: `translateX(44px) rotate(${deg}deg)` }}
                      />
                    ))}
                  </div>
                </div>
              ...
              {/* Main prompt */}
              <div
                className="max-w-3xl mx-auto p-5 lg:p-6 rounded-2xl bg-black/10 backdrop-blur-sm shadow-inner"
              >
                <p className="text-lg lg:text-xl leading-relaxed" style={{ color: config.textColor }}>
                  {slide.content}
                </p>
              </div>
              ...
              {(slide as typeof slides[0] & { prompts?: string[] }).prompts && (
                <div className="max-w-2xl mx-auto space-y-2">
                  {(slide as typeof slides[0] & { prompts?: string[] }).prompts!.map((prompt, i) => (
                    <div
                      key={i}
                      className="flex items-center gap-3 p-3 rounded-xl bg-black/5 border border-black/10"
                    >
                      <div
                      ...
                      <p className="text-base" style={{ color: config.textColor }}>{prompt}</p>
                    </div>
                  ))}
                </div>
              )}
              ...
              <div className="flex items-center justify-center gap-2 pt-2">
                ...
                <span className="text-sm font-medium" style={{ color: config.accentColor }}>Take 2-3 minutes to reflect...</span>
              </div>
            </div>
          ) : type === "activity" ? (
            ...
            <div className="space-y-4 lg:space-y-5">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <span className="inline-flex items-center gap-2 text-xs font-bold text-white/60 uppercase tracking-widest">
                    <Play className="h-3 w-3" />
                    Interactive Activity
                  </span>
                  <h2
                    className="text-2xl sm:text-3xl lg:text-4xl font-bold mt-0.5"
                    style={{ color: config.accentColor }}
                  >
              ...
              {/* Main content card */}
              <div
                className="p-5 lg:p-6 rounded-2xl bg-white/10 backdrop-blur-sm border border-white/20 shadow-xl"
              >
                <p className="text-lg lg:text-xl text-white/90 leading-relaxed mb-4">
                  {slide.content}
                </p>
                ...
                {(slide as typeof slides[0] & { instructions?: string[] }).instructions && (
                  <div className="space-y-2 pt-4 border-t border-white/20">
                    <p className="text-xs font-bold text-white/60 uppercase tracking-widest mb-2">Instructions</p>
                    {(slide as typeof slides[0] & { instructions?: string[] }).instructions!.map((instruction, i) => (
                      ...
                      >
                        <div
                          className="flex-shrink-0 h-8 w-8 rounded-lg flex items-center justify-center font-bold text-white text-sm"
                          style={{ backgroundColor: config.iconBg }}
                        >
                          {i + 1}
                        </div>
              ...
              <div className="flex flex-wrap items-center gap-4 text-white/70">
                <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/10">
                  ...
                  <span className="font-medium text-sm">10-15 minutes</span>
                </div>
                <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/10">
                  <Users className="h-5 w-5" />
                  <span className="font-medium text-sm">Small groups (3-4 people)</span>
                </div>
              </div>
            </div>
          ) : type === "summary" ? (
            ...
            <div className="text-center space-y-4 lg:space-y-5">
              ...
              <div className="flex justify-center">
                <div
                  ...
                  style={{ backgroundColor: config.iconBg }}
                >
                  <CheckCircle className="h-9 w-9 lg:h-10 lg:w-10 text-white" />
                </div>
              </div>
              ...
              <div className="flex items-center justify-center gap-3">
                <div className="h-1 w-12 rounded-full" style={{ backgroundColor: config.accentColor }} />
                <Award className="h-5 w-5" style={{ color: config.accentColor }} />
                <div className="h-1 w-12 rounded-full" style={{ backgroundColor: config.accentColor }} />
              </div>
              ...
              {slide.title.includes("Completion") && (
                <div className="pt-2">
                  <div className="inline-flex items-center gap-3 px-6 py-3 rounded-xl bg-gradient-to-r from-[#D8A75F] to-[#c9954a] shadow-xl">
                    <Star className="h-6 w-6 text-white" />
                    <span className="text-lg font-bold text-white">Part 1 Complete!</span>
                    <Star className="h-6 w-6 text-white" />
                  </div>
                </div>
              )}
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
                  {(slide as typeof slides[0] & { modules?: string[] }).modules!.map((module, i) => {
                    ...
                    return (
                      <div
                        key={i}
                        className="p-4 rounded-xl bg-white/10 backdrop-blur-sm border border-white/15 hover:bg-white/15 transition-all duration-300"
                      >
                        <div
                          className="h-10 w-10 rounded-xl flex items-center justify-center mb-2 shadow-lg"
                          style={{ backgroundColor: config.iconBg }}
                        >
                          <ModuleIcon className="h-5 w-5 text-white" />
                        </div>
                        <h3 className="text-sm font-bold text-white mb-1">{module}</h3>
            ...
            <div className="space-y-5 lg:space-y-6">
              <div className="flex items-center gap-4">
                <div
                  ...
                  style={{ backgroundColor: config.iconBg }}
                >
                  <Layers className="h-7 w-7 lg:h-8 lg:w-8 text-white" />
                </div>
                <h2
                  className="text-2xl sm:text-3xl lg:text-4xl font-bold"
                  style={{ color: config.accentColor }}
              ...
              <div
                className="p-5 lg:p-6 rounded-2xl bg-white/10 backdrop-blur-sm border border-white/20"
              >
            ...
            <div className="space-y-4 lg:space-y-5">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-2">
                  <div className="h-1 w-16 rounded-full" style={{ backgroundColor: config.iconBg }} />
                  <div className="h-1 w-6 rounded-full" style={{ backgroundColor: config.iconBg, opacity: 0.5 }} />
                  <div className="h-1 w-3 rounded-full" style={{ backgroundColor: config.iconBg, opacity: 0.25 }} />
                </div>
              </div>
              ...
              {(slide as typeof slides[0] & { examples?: string[] }).examples && (
                <div className="flex flex-wrap gap-3 pt-2">
                  {(slide as typeof slides[0] & { examples?: string[] }).examples!.map((example, i) => (
                    <div
                      key={i}
                      className="px-4 py-2 rounded-xl bg-white/10 border border-white/15 text-sm text-white/90 font-medium"
                    >
                      {example}
                    </div>
                  ))}
              ...
              {(slide as typeof slides[0] & { responsibilities?: string[] }).responsibilities && (
                <div className="grid grid-cols-2 gap-3 pt-2">
                  {(slide as typeof slides[0] & { responsibilities?: string[] }).responsibilities!.map((resp, i) => {
                    const respIcons = [Calendar, RefreshCw, FileText, MessageSquare] as const;
                    const RespIcon = respIcons[i % respIcons.length] ?? FileText;
                    return (
                      <div key={i} className="flex items-center gap-3 p-3 rounded-xl bg-white/10 backdrop-blur-sm border border-white/10">
                        <div className="flex-shrink-0 h-8 w-8 rounded-lg bg-gradient-to-br from-[#D8A75F] to-[#c9954a] flex items-center justify-center shadow">
                          <RespIcon className="h-4 w-4 text-white" />
                        </div>
                        <p className="text-sm font-medium text-white/90">{resp}</p>
                      </div>
                    );
                  })}
                </div>
                  ...
                  {(slide as typeof slides[0] & { tools?: string[] }).tools!.map((tool, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="text-sm text-white/90 font-medium">{tool}</span>
                      </div>
                    );
                  })}
                </div>
                ...
                <div className="flex flex-wrap gap-2 pt-2">
                  {(slide as typeof slides[0] & { principles?: string[] }).principles!.map((principle, i) => (
                    ...
                    >
                      ...
                      <span className="text-sm text-white/90 font-medium">{principle}</span>
                    </div>
                  ))}
                </div>
              )}
                  ...
                  {(slide as typeof slides[0] & { factors?: string[] }).factors!.map((factor, i, arr) => (
                    <div key={i} className="flex items-center gap-3">
                      <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/10 border border-white/15">
                        ...
                        <span className="text-sm text-white/90 font-medium">{factor}</span>
                      </div>
                      {i < arr.length - 1 && (
                ...
                <div className="grid grid-cols-4 gap-3 pt-2">
                  {(slide as typeof slides[0] & { systems?: string[] }).systems!.map((system, i) => {
                    ...
                    return (
                      <div
                        key={i}
                        className="p-3 rounded-xl bg-white/10 border border-white/15 text-center"
                      >
                        <SysIcon className="h-6 w-6 text-white/70 mx-auto mb-2" />
                        <span className="text-xs text-white/90 font-medium">{system}</span>
                      </div>
                    );
                  })}
                </div>
              ...
              {(slide.title.includes("Trust") ||
                ...
                <SlideImage
                  ...
                  className="h-28 lg:h-32 max-w-sm"
                />
              )}
            </div>
          )}
        ...
        {/* Footer */}
        <div className="mt-auto pt-4 lg:pt-6 flex items-center justify-center text-white/50 text-xs lg:text-sm border-t border-white/10">
          <span>© CHW360 | Organizational Skills – Part 1 | Educational Use Only | Not Medical Advice.</span>
        </div>
      </div>
    </div>
  );
...
function TableOfContents({
  ...
  const sections = [
    ...
    { label: "Core Concepts", slides: slides.filter((_, i) => i >= 9 && i < 20) },
    { label: "Practical Skills", slides: slides.filter((_, i) => i >= 20 && i < 40) },
    { label: "Advanced Topics & Summary", slides: slides.filter((_, i) => i >= 40) },
  ];
...
function KeyboardShortcuts({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md" onClick={onClose}>
      <div
        className="relative w-full max-w-lg mx-4 p-8 rounded-3xl shadow-2xl"
        style={{ backgroundColor: colors.background }}
        onClick={(e) => e.stopPropagation()}
      >
        <button
          onClick={onClose}
          className="absolute top-4 right-4 h-10 w-10 rounded-xl flex items-center justify-center hover:bg-black/10 transition-colors"
        >
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h2 className="text-2xl font-bold" style={{ color: colors.text }}>Keyboard Shortcuts</h2>
            <p className="text-sm" style={{ color: colors.text + "80" }}>Navigate like a pro</p>
          </div>
        </div>

        <div className="space-y-3">
          {shortcuts.map((shortcut, i) => (
            <div key={i} className="flex items-center justify-between p-3 rounded-xl bg-black/5">
              <span className="font-medium" style={{ color: colors.text }}>{shortcut.action}</span>
              <div className="flex items-center gap-2">
                {shortcut.keys.map((key, j) => (
                  <span key={j}>
                    ...
                    {j < shortcut.keys.length - 1 && (
                      <span className="mx-1 text-xs" style={{ color: colors.text + "60" }}>or</span>
                    )}
                  </span>
                ))}
              </div>
...
function ThumbnailStrip({
  ...
  useEffect(() => {
    if (isOpen && stripRef.current) {
      const thumb = stripRef.current.querySelector(`[data-slide="${currentSlide}"]`);
      if (thumb) {
  ...
  return (
    <div
      className="fixed bottom-0 left-0 right-0 z-40 border-t shadow-2xl backdrop-blur-md transition-all duration-300"
      style={{
    ...
    >
      <div
        ref={stripRef}
        className="flex items-center gap-3 px-6 py-4 overflow-x-auto scrollbar-hide"
          ...
          return (
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center p-2">
                <span className="text-white font-bold text-lg">{slide.num}</span>
                <span className="text-white/70 text-[10px] text-center line-clamp-1 px-1">
                  {slide.title.length > 20 ? slide.title.substring(0, 20) + "..." : slide.title}
                </span>
              </div>
            </button>
          );
...
function PresentationTimer({ isVisible }: { isVisible: boolean }) {
  ...
  return (
    <div
      className="fixed bottom-6 right-6 z-30 flex items-center gap-3 px-5 py-3 rounded-2xl shadow-xl backdrop-blur-md"
    ...
    >
      ...
      <button
        ...
        className="h-8 w-8 rounded-lg flex items-center justify-center bg-white/10 hover:bg-white/20 transition-colors"
      >
        {isRunning ? (
  ...
  return (
    ...
    >
        ...
        <div className="px-6 lg:px-8 py-4 grid grid-cols-3 items-center">
          ...
          <div className="flex items-center justify-end gap-2">
            <button
              ...
              className="h-11 w-11 rounded-xl flex items-center justify-center transition-all hover:bg-black/10 hover:scale-105"
            ...
            <button
              ...
              className={`h-11 w-11 rounded-xl flex items-center justify-center transition-all hover:scale-105 ${
      ...
      <button
        ...
        className={`fixed top-4 left-1/2 -translate-x-1/2 z-50 flex items-center gap-2 px-4 py-2 rounded-full shadow-lg backdrop-blur-md transition-all duration-500 ${
          showNavHint ? "opacity-100 translate-y-0" : "opacity-0 pointer-events-none -translate-y-4"
        }`}
        style={{ backgroundColor: colors.text + "E0" }}
