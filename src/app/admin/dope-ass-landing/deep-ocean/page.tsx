...
function DeepOceanLandingPageContent() {
  ...
  return (
    <DomainLayout
      headerClassName="border-b border-white/10 bg-gradient-to-r from-[#1e3a8a] to-[#0f766e] backdrop-blur-sm"
      footerClassName="mt-auto border-t border-white/10 bg-gradient-to-r from-[#1e3a8a] to-[#0f766e] backdrop-blur-sm"
    >
        ...
        <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-4 py-16">
          ...
          <div className="mb-6 text-center">
            ...
            <p className="mx-auto max-w-2xl text-xl text-neutral-300">
              Dive into the mysterious depths of the ocean.
              <br />
...
export default function DeepOceanLandingPage() {
  return (
    <Suspense fallback={<div className="flex min-h-screen items-center justify-center">Loading...</div>}>
      <DeepOceanLandingPageContent />
    </Suspense>
  );
}
