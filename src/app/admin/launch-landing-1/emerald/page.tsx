...
function EmeraldLaunchLanding1PageContent() {
  ...
  return (
    <DomainLayout
      ...
      footerClassName="mt-auto border-t border-white/10 bg-[#059669] backdrop-blur-sm"
    >
      <BackButton href="/admin" label="Back to Hub" />
      <div className="relative min-h-screen overflow-hidden bg-[#059669]">
...
export default function EmeraldLaunchLanding1Page() {
  return (
    <Suspense fallback={<div className="flex min-h-screen items-center justify-center">Loading...</div>}>
      <EmeraldLaunchLanding1PageContent />
    </Suspense>
  );
}
