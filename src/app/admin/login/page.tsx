...
export default function AdminLoginPage() {
  ...
  const handleClaimAccount = async () => {
    ...
    try {
      ...
      const redirectUrl = `${origin}/auth/callback?next=/admin/set-password`;
          ...
          >
            <CardContent className="p-8">
              ...
              <p className="mb-6 text-center text-sm text-gray-400">
                Your team account is ready to be activated. We&apos;ll send you
                a magic link to set up your password.
              </p>
  ...
  if (mode === "claim-form") {
    const handleCheckEmail = async (e: React.FormEvent) => {
      ...
      if (data?.canClaim) {
        ...
        setError("No team account found for this email. Contact your admin.");
      }
    };
