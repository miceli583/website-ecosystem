...
export default function StartupPage() {
  ...
  return (
    <DomainLayout>
      <PlaygroundLayout>
        <div className="min-h-full bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 dark:from-purple-950 dark:via-pink-950 dark:to-orange-950">
          {/* Hero Section */}
          ...
          <div className="relative overflow-hidden bg-gradient-to-r from-purple-600 via-pink-600 to-orange-600 py-20">
            ...
            <div className="relative z-10 mx-auto max-w-4xl px-6 text-center text-white">
              ...
              <p className="mb-8 text-xl">
                Join thousands of founders who are already building the future.
