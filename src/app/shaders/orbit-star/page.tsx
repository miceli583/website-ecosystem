...
// Orbit Star shader - Miracle Mind logo
...
export default function OrbitStarPage() {
  return (
    <ShaderLayout>
        ...
        <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
          <div className="max-w-2xl space-y-6 p-8 text-center">
            ...
            <p className="text-xl text-white/80">
              The Miracle Mind emblem - concentric orbits with swirling paths
              symbolizing the infinite dance of consciousness and creation
            </p>
          </div>
        </div>
      </div>
