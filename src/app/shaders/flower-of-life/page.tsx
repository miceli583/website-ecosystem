...
// Flower of Life shader code
const FLOWER_OF_LIFE_SHADER = `
  ...
  return (
    <ShaderLayout>
      <div className="relative h-screen w-full overflow-hidden bg-black">
        <ShadertoyRenderer
          fragmentShader={FLOWER_OF_LIFE_SHADER}
        ...
        <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
          <div className="max-w-2xl space-y-6 p-8 text-center">
            ...
            <p className="text-xl text-white/80">
              Sacred geometry pattern with glowing circles and mystical energy
            </p>
          </div>
        </div>
      </div>
