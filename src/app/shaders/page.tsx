...
const SHADERS = [
  {
    ...
    title: "Orbit Star",
    description:
      "The Miracle Mind emblem - concentric orbits with swirling golden paths",
    color: "amber",
...
function ShadersPageContent() {
  ...
  return (
    <div
      className="via-background dark:via-background min-h-screen p-6"
      style={{
        background:
    ...
    >
      ...
      <Link
        href={`/?domain=matthew${domainParam ? `&${domainParam.slice(1)}` : ""}`}
      >
        <Button
          size="lg"
